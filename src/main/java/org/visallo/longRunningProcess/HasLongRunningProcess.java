...
public class HasLongRunningProcess extends org.visallo.tools.ontology.ingest.common.RelationshipBuilder {
  public static final String IRI = "http://visallo.org/longRunningProcess#hasLongRunningProcess";


  public HasLongRunningProcess(String id, org.visallo.user.User outVertex, org.visallo.longRunningProcess.LongRunningProcess inVertex) {
