...
public class TitleFormulaEntityNoSearch extends org.visallo.dev.TitleFormulaEntity {
  public static final String IRI = "http://visallo.org/dev#titleFormulaEntityNoSearch";

  public TitleFormulaEntityNoSearch(String id) { super(id); }
