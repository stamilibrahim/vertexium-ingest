...
public class EmailAddress extends org.visallo.dev.ContactInformation {
  public static final String IRI = "http://visallo.org/dev#emailAddress";

  public EmailAddress(String id) { super(id); }
